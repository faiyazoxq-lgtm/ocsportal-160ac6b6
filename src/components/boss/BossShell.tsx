...
export function BossShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-background pt-11">
      <div className="fixed inset-x-0 top-0 z-50 flex h-11 items-center gap-2 border-b border-indigo-500/30 bg-indigo-600 px-5 text-sm font-bold uppercase tracking-wider text-white shadow-sm">
